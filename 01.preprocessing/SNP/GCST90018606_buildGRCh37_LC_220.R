...
#
summary = fread("GCST90018606_buildGRCh37_LC_220.tsv.gz")
summary = data.frame(summary)
title = "GCST90018606_LC"
#
...
write.table(summary, "GCST90018606_buildGRCh37_LC_220_metal.txt", sep = "\t", row.names = F, quote = F)
