...
#
summary = fread("GCST90319877.tsv")
summary = data.frame(summary)

#
title = "GCST90319877_LC"
colnames(summary)
snp_info = summary[, c("rsid", "chromosome", "base_pair_location")]
...
setwd(wd)
storage = paste0("FS.", title, "_density.png")
ggsave(storage, width = 6, height = 4)

#
summary$marker = summary$rsid
...
storage = paste0(title, "_metal.txt")
