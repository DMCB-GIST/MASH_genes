...
#
summary = fread("GCST90436370.tsv.gz")
summary = data.frame(summary)
title = "GCST90436370_LC"

#
#source("c:/Dropbox/ddasic/bi/SNP_density_plot.R")
snp_info = summary[, c("X.CHROM", "POS")]
...
#
id = paste0(summary$X.CHROM, "_", summary$POS)
...
summary$chr = summary$X.CHROM
summary$pos = summary$POS
summary$effect = summary$beta
summary$stderr = summary$sebeta
summary$p = summary$pval
