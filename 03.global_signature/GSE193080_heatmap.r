...
pheno_type = c("CN", "F1", "F2", "F3F4")

#
idx.c = grep("0", phenotype)
idx.d1 = grep("1", phenotype)
idx.d2 = grep("2", phenotype)
idx.d3 = grep("3", phenotype)
idx.d4 = grep("4", phenotype)
phenotype[idx.c] = pheno_type[1]
phenotype[idx.d1] = pheno_type[2]
phenotype[idx.d2] = pheno_type[3]
phenotype[idx.d3] = pheno_type[4]
phenotype[idx.d4] = pheno_type[4]
