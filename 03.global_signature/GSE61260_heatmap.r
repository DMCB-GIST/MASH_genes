...
pheno_color = c("darkolivegreen1", "darkolivegreen3", "gold3", "darkred", "grey")
pheno_type = c("CN", "Obese", "NAFL", "NASH", "Other")

#
idx.c1 = grep("Control", phenotype)
idx.c2 = grep("Obese", phenotype)
idx.d1 = grep("NAFLD", phenotype)
idx.d2 = grep("NASH", phenotype)
phenotype[] = pheno_type[5]
